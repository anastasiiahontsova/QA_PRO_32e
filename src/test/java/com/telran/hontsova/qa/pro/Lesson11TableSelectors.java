...
import java.util.concurrent.TimeUnit;
    ...
    public class Lesson11TableSelectors {
        ...
        public void SetUp (){
            ...
            webDriver.navigate().to("https://www.w3schools.com/css/css_selectors.asp");
...
//        wd.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        ...
        public void testTableCssSelectors(){
            // return the 1st row
            WebElement firstRow = webDriver.findElement(By.cssSelector("tr:nth-child(1)"));
...
//      https://www.w3.org/wiki/CSS/Selectors/pseudo-classes/:nth-last-child#:~:text=The%20%3Anth%2Dlast%2Dchild,and%20has%20a%20parent%20element
            ...
            WebElement tableElement2 = webDriver.findElement(By.cssSelector("tr:nth-child(2) td:first-child"));
...
//        // sout - System.out.println
            ...
            WebElement tableElement3 = webDriver.findElement(By.cssSelector("tr:nth-child(2) td:last-child"));
            System.out.println("tableElement3 text: " + tableElement3.getText());

            // returns 2nd row and the 2nd value
            WebElement tableElement4 = webDriver.findElement(By.cssSelector("tr:nth-child(2) td:nth-child(2)"));
            System.out.println("tableElement4 text: " + tableElement4.getText());

            // returns 3 elements of the 1st row
            List<WebElement> row3TableElements = webDriver.findElements(By.cssSelector("tr:nth-child(1) th"));
...
//        }
            ...
            List<WebElement> firstColumtTableElements = webDriver.findElements(By.cssSelector("td:nth-child(1)"));
            ...
            List<WebElement> thTableElements = webDriver.findElements(By.cssSelector("th"));
